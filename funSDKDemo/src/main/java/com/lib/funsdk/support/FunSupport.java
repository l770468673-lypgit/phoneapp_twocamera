...
import com.lib.funsdk.support.utils.LUtils;
...
public class FunSupport implements IFunSDKResult {
    ...
    private static final String APP_UUID = "bbb2943e7df441e48b5990c0cb4814e4";
    private static final String APP_KEY = "190493b574fe417f8794330af8f2bab3";
    private static final String APP_SECRET = "c43154a46b304017b8fa4eb424e7474f";
    ...
    public void init(Context context) {
        ...
        LUtils.i(TAG, "FunSDK.SysInitNet : " + result);
        ...
        LUtils.i(TAG, "FunSDK.RegUser : " + mFunUserHandler);

        // 注册设备连接和断开的消息监听
        result = FunSDK.SetFunIntAttr(EFUN_ATTR.FUN_MSG_HANDLE, mFunUserHandler);
        LUtils.i(TAG, "FunSDK.SetFunIntAttr(EFUN_ATTR.FUN_MSG_HANDLE) : " + result);
    ...
    public void registerOnFunDeviceAlarmPicListener(OnFunDeviceAlarmPicListener l) {
        if (!mListeners.contains(l)) {
            mListeners.add(l);
        }
    }
    ...
    public void removeOnFunDeviceAlarmPicListener(OnFunDeviceAlarmPicListener l) {
        if (mListeners.contains(l)) {
            mListeners.remove(l);
        }
    }
    ...
    public void dumpDeviceList() {
        LUtils.d(TAG, "DeviceList:" + mDeviceList.size());
        for (FunDevice devInfo : mDeviceList) {
            LUtils.d(TAG, "     dev : " + devInfo.toString());
        }
    }
    ...
    public boolean login(String username, String password) {
        ...
        Log.d(TAG, "login  mTmpLoginUserName" + mTmpLoginUserName);
        Log.d(TAG, "login mTmpLoginPassword" + mTmpLoginPassword);
        return (result == 0);
    }
    ...
    public boolean requestDeviceList() {
        LUtils.d(TAG, "---> call requestDeviceList()");
        int result = FunSDK.SysGetDevList(getHandler(),
                mLoginUserName, mLoginPassword, 0);
        Log.d(TAG, "mTmpLoginUserName" + mTmpLoginUserName);
        Log.d(TAG, "mTmpLoginPassword" + mTmpLoginPassword);
        return (result == 0);
    }
     ...
     * 第三方获取设备列表
     */
    public int getDeviceListEX() {
        //        int result = FunSDK.SysGetDevListEx(getHandler(), mTmpLoginUserName, mTmpLoginPassword, 3, 0);
        int result = FunSDK.SysGetDevList(getHandler(),
                mTmpLoginUserName, mTmpLoginPassword, 0);
            ...
            public void run() {
                ...
                for (int i = 0; i < scanSecond; i++) {
                    ...
                    for (int iDev = mAPDeviceList.size() - 1; iDev >= 0; iDev--) {
                        ...
                        if (!isExist) {
                            // 不存在了,从列表移除
                            LUtils.e("AP", "AP Deice offline : " + funDevice.devName);
                    ...
                    for (ScanResult scanResult : scanResults) {
                        ...
                        if (null != funDevice) {
                            ...
                            //							LUtils.i("test", "AddDevice:" + devInf.toString());
    ...
    private void requestDeviceConfigDone(FunDevice funDevice, String configName) {
        ...
        if (devCfg == null) {
            LUtils.e(TAG, "Error!!! must not be null here!");
        } else if (!devCfg.configName.equals(configName)) {
            LUtils.e(TAG, "Error!!! must be the same configName here! [" + devCfg.configName + "] != [" + configName + "]");
        } else {
            synchronized (mDeviceGetConfigQueue) {
                mIsGettingConfig = false;
            }
    ...
    public boolean requestDeviceSetConfig(FunDevice funDevice, Object parmObj) {
        ...
        LUtils.i("test", "requestDeviceSetConfig : " + funDevice.getId());
    ...
    public boolean requestDeviceFileList(FunDevice funDevice,
        ...
        LUtils.i("SDK_LOG", "--> DevFindFile : info = " + info.toString());
        return (result == 0);
    }
    ...
    public boolean requestDeviceFileListByTime(FunDevice funDevice,
        ...
        int result = FunSDK.DevFindFileByTime(getHandler(),
                ...
                10000, 0);
        LUtils.i("SDK_LOG", "--> DevFindFileByTime : info = " + info.toString());
        return (result == 0);
    }
...
//        return FunSDK.DevStarTalk(getHandler(), funDevice.getDevSn(),0,0, 0);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_GET_DEVICE_CONFIG: {
                    LUtils.e(TAG, TAG + " requestDeviceConfigFromQueue()");
                    requestDeviceConfigFromQueue();
                }
                break;
                case MESSAGE_GET_DEVICE_CONFIG_TIMEOUT: {
                    LUtils.e(TAG, TAG + " resetTimeoutDeviceConfigFromQueue()");
    ...
    private void mpsInit() {
        ...
        try {
            if (null != mLoginUserName
                ...
                LUtils.i(TAG, "MpsClient init with user : " + mLastMpsUserName);
                LUtils.i(TAG, "pushToken : ==" + pushToken);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void mpsLinkDevice(FunDevice funDevice) {
        if (null != funDevice) {
            LUtils.d(TAG, "LinkDev : " + funDevice.getDevSn()
    ...
    public void setDevSleep(String devSn) {
        FunSDK.DevSleep(mFunUserHandler, devSn, 0);
    }

    public void setDevWakeUp(FunDevice funDevice) {
        FunSDK.DevWakeUp(mFunUserHandler, funDevice.getDevSn(), funDevice.getId());
    }

    public void getAlarmPic(FunDevice device, String savePath, String json) {
        int ret = MpsClient.DownloadAlarmImage(getHandler(), device.getDevSn(), savePath, json, 0, 0, 0);
    }

    @Override
    public int OnFunSDKResult(Message msg, MsgContent msgContent) {
        LUtils.d(TAG, "msg.what : " + msg.what);
        LUtils.d(TAG, "msg.arg1 : " + msg.arg1 + " [" + FunError.getErrorStr(msg.arg1) + "]");
        LUtils.d(TAG, "msg.arg2 : " + msg.arg2);
        if (null != msgContent) {
            LUtils.d(TAG, "msgContent.sender : " + msgContent.sender);
            LUtils.d(TAG, "msgContent.seq : " + msgContent.seq);
            LUtils.d(TAG, "msgContent.str : " + msgContent.str);
            LUtils.d(TAG, "msgContent.arg3 : " + msgContent.arg3);
            LUtils.d(TAG, "msgContent.pData : " + msgContent.pData);
        }
        switch (msg.what) {
            case EUIMSG.SYS_GET_DEV_INFO_BY_USER_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_GET_DEV_INFO_BY_USER_XM");
            ...
            break;
            case EUIMSG.DEV_SEND_MEDIA_DATA:
                LUtils.i(TAG, "EUIMSG.DEV_SEND_MEDIA_DATA , 语音发送");
                if (msg.arg1 == FunError.EE_OK) {
                    LUtils.i(TAG, " 语音发送成功" + msg.arg1);
                } else {
                    LUtils.i(TAG, " 语音发送失败" + msg.arg1);
                }
                break;
            case EUIMSG.START_SAVE_MEDIA_FILE:
                LUtils.i(TAG, "EUIMSG.START_SAVE_MEDIA_FILE , 开始录像");
                if (msg.arg1 == FunError.EE_OK) {
                    LUtils.i(TAG, " 开始录像" + msg.arg1);
                } else {
                    LUtils.i(TAG, " 开始录像失败" + msg.arg1);
                }
                break;
            case EUIMSG.STOP_SAVE_MEDIA_FILE:
                LUtils.i(TAG, "EUIMSG.STOP_SAVE_MEDIA_FILE , 停止录像");

                if (msg.arg1 == FunError.EE_OK) {

                    LUtils.i(TAG, " 停止录像 成功" + msg.arg1);
                } else {
                    LUtils.i(TAG, " 停止录像 失败" + msg.arg1);
                }
                break;

            case EUIMSG.SYS_CHECK_USER_REGISTE: {
                LUtils.i(TAG, "EUIMSG.SYS_CHECK_USER_REGISTE");
                if (msg.arg1 == FunError.EE_OK) {
                    //回调
                    for (OnFunListener l : mListeners) {
            ...
            case EUIMSG.SYS_LOGOUT_TO_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_LOGOUT_TO_XM");
            ...
            case EUIMSG.SYS_SEND_EMAIL_CODE:
                LUtils.i(TAG, "EUIMSG.SYS_SEND_EMAIL_CODE");
            case EUIMSG.SYS_GET_PHONE_CHECK_CODE: {
                LUtils.i(TAG, "EUIMSG.SYS_GET_PHONE_CHECK_CODE");
            ...
            case EUIMSG.SYS_REGISTE_BY_EMAIL:
                LUtils.i(TAG, "EUIMSG.SYS_REGISTE_BY_EMAIL");
            case EUIMSG.SYS_REGISER_USER_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_REGISER_USER_XM");
            ...
            case EUIMSG.SYS_EDIT_PWD_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_EDIT_PWD_XM");
            ...
            case EUIMSG.SYS_CHECK_PWD_STRENGTH: {
                LUtils.i(TAG, "EUIMSG.SYS_CHECK_PWD_STRENGTH");
            ...
            case EUIMSG.SYS_SEND_EMAIL_FOR_CODE:
                LUtils.i(TAG, "EUIMSG.SYS_SEND_EMAIL_FOR_CODE");
            case EUIMSG.SYS_FORGET_PWD_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_FORGET_PWD_XM");
            ...
            case EUIMSG.SYS_CHECK_CODE_FOR_EMAIL:
                LUtils.i(TAG, "EUIMSG.SYS_CHECK_CODE_FOR_EMAIL");
            case EUIMSG.SYS_REST_PWD_CHECK_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_REST_PWD_CHECK_XM");
            ...
            case EUIMSG.SYS_PSW_CHANGE_BY_EMAIL:
                LUtils.i(TAG, "EUIMSG.SYS_PSW_CHANGE_BY_EMAIL");
            case EUIMSG.SYS_RESET_PWD_XM: {
                LUtils.i(TAG, "EUIMSG.SYS_RESET_PWD_XM");
            ...
            {
                LUtils.i(TAG, "EUIMSG.SYS_GET_USER_INFO");
            ...
            {
                LUtils.i(TAG, "EUIMSG.SYS_GET_DEV_STATE");
            ...
            {
                LUtils.i(TAG, "EUIMSG.SYS_GET_DEV_INFO_BY_USER");
                LUtils.i(TAG, "msg.arg1==" + msg.arg1);
                LUtils.i(TAG, "msgContent.pData==" + msgContent.pData);
            ...
            {
                LUtils.i(TAG, "EUIMSG.SYS_ADD_DEVICE 用户添加设备 ");
                if (msg.arg1 == FunError.EE_OK) {
                    // 用户添加设备成功
                    for (OnFunListener l : mListeners) {
                        if (l instanceof OnFunDeviceListener) {
            ...
            case EUIMSG.SYS_DELETE_DEV: // 用户删除设备
            {
                ...
                LUtils.i(TAG, "EUIMSG.SYS_DELETE_DEV");
                if (msg.arg1 == FunError.EE_OK) {
                    // 用户添加设备成功
                    for (OnFunListener l : mListeners) {
                        if (l instanceof OnFunDeviceListener) {
            ...
            {
                LUtils.i(TAG, "EUIMSG.SYS_CHANGEDEVINFO");
            ...
            {
                LUtils.i(TAG, "EUIMSG.DEV_LOGIN 设备登录");
                ...
                if (null != funDev) {
                    ...
                    LUtils.e(TAG, "Recive -> EUIMSG.DEV_LOGIN, but no device matched.");
                }
            }
            break;
            case EUIMSG.DEV_GET_CONFIG: {
                LUtils.i(TAG, "EUIMSG.DEV_GET_CONFIG");
            ...
            case EUIMSG.DEV_CMD_EN: {
                ...
                LUtils.i(TAG, "EUIMSG.DEV_GET_JSON");
                ...
                if (null != funDevice) {
                    ...
                    if (msg.arg1 < 0) {
                        ...
                        LUtils.i(TAG, "EUIMSG.DEV_GET_JSON --> json: " + json);
                        LUtils.i(TAG, "configName = " + msgContent.str);
                    ...
                    // 不是设备发出去的请求回应,暂时不处理
                    LUtils.e(TAG, "Recive -> EUIMSG.DEV_GET_JSON, but no device matched.");
                }
            }
            break;
            case EUIMSG.DEV_SET_JSON: {
                LUtils.i(TAG, "EUIMSG.DEV_SET_JSON");
                ...
                if (null != funDevice) {
                    ...
                    // 不是设备发出去的请求回应,暂时不处理
                    LUtils.e(TAG, "Recive -> EUIMSG.DEV_SET_JSON, but no device matched.");
                }
            }
            break;
            case EUIMSG.DEV_GET_CHN_NAME: {                    //获取通道信息
                LUtils.i(TAG, "EUIMSG.DEV_GET_CHN_NAME");
            ...
            case EUIMSG.DEV_OPTION: {
                LUtils.i(TAG, "EUIMSG.DEV_OPTION");
            ...
            {
                LUtils.i(TAG, "EUIMSG.DEV_FIND_FILE");
                ...
                if (null != funDevice
                    ...
                    if (null != picInfo) {
                        for (int i = 0; i < datas.length; i++) {
                            // LUtils.d("test", datas[i].toString());
                        ...
                        LUtils.e("DEV_FIND_FILE", "search file error!");
                    }
            ...
            {
                LUtils.i(TAG, "DEV_FIND_FILE_BY_TIME");
            ...
            case EUIMSG.DEV_SEARCH_PIC: {
                LUtils.i(TAG, "EUIMSG.DEV_SEARCH_PIC" + msg.arg1);

                if (msg.arg1 == FunError.EE_OK) {
                    // 文件下载成功
                    LUtils.i(TAG, "EUIMSG.DEV_SEARCH_PIC 文件下载成功 ");
                    ...
                    for (OnFunListener l : mListeners) {
                        if (l instanceof OnFunDeviceFileListener) {
                            ((OnFunDeviceFileListener) l).onDeviceFileDownCompleted(mCurrDevice,
                                    path, msgContent.seq);
                            LUtils.i(TAG, "EUIMSG.DEV_SEARCH_PIC" + path);
                        }
                    }
                } else {
                    LUtils.i(TAG, "EUIMSG.DEV_SEARCH_PIC 文件下载失败 ");
                }
            }
            break;

            case EUIMSG.DEV_START_TALK: {
                LUtils.i(TAG, "EUIMSG.DEV_START_TALK");
            ...
            case EUIMSG.DEV_STOP_TALK: {
                LUtils.i(TAG, "EUIMSG.DEV_STOP_TALK");
            ...
            case EUIMSG.SAVE_IMAGE_FILE: {
                LUtils.i(TAG, "EUIMSG.SAVE_IMAGE_FILE");
            ...
            case EUIMSG.ON_FILE_DLD_COMPLETE: {
                LUtils.i(TAG, "EUIMSG.ON_FILE_DLD_COMPLETE");
            ...
            case EUIMSG.ON_FILE_DLD_POS: {
                LUtils.i(TAG, "EUIMSG.ON_FILE_DLD_POS");
            ...
            case EUIMSG.ON_FILE_DOWNLOAD: {
                LUtils.i(TAG, "EUIMSG.ON_FILE_DOWNLOAD");
            ...
            case EUIMSG.DEV_ON_RECONNECT: {
                LUtils.i(TAG, "EUIMSG.DEV_ON_RECONNECT");
                if (msg.arg1 == FunError.EE_OK) {
            ...
            case EUIMSG.DEV_ON_DISCONNECT: {
                LUtils.i(TAG, "EUIMSG.DEV_ON_DISCONNECT");
                if (msg.arg1 == FunError.EE_OK) {
                    FunDevice funDev = findDeviceBySn(msgContent.str);
                    if (null != funDev) {
            ...
            case EUIMSG.DEV_ON_TRANSPORT_COM_DATA: {
                // 收到串口数据
                LUtils.i(TAG, "EUIMSG.DEV_ON_TRANSPORT_COM_DATA");
            ...
            case EUIMSG.MC_ON_AlarmCb: {
                LUtils.e(TAG, TAG + "EUIMSG.MC_ON_AlarmCb");
            ...
            {
                LUtils.i(TAG, "EUIMSG.MC_LinkDev");
            }
            break;
            case EUIMSG.MC_UnlinkDev: // 解除报警关联
            {
                LUtils.i(TAG, "EUIMSG.MC_UnlinkDev");
            }
            break;
            case EUIMSG.MC_SearchAlarmInfo: // 设备历史报警消息获取
            {
                LUtils.i(TAG, "EUIMSG.MC_SearchAlarmInfo");
                    ...
                    if (msg.arg1 < 0) {
                        ...
                        for (OnFunListener l : mListeners) {
                            if (l instanceof OnFunDeviceAlarmListener) {
                                ...
                                LUtils.i(TAG, "EUIMSG.MC_LinkDev  onDeviceAlarmSearchSuccess " + infos);
                            }
                        }
                    }
                }
            ...
            case EUIMSG.MC_SearchAlarmPic:
                LUtils.e(TAG, "OnFunSDKResult: MC_SearchAlarmPic");
                for (OnFunListener l : mListeners) {
                    if (l instanceof OnFunDeviceAlarmPicListener) {
                        ((OnFunDeviceAlarmPicListener) l).onDeviceAlarmSearchPicSuccess(msgContent.str);
                    }
                }
                break;
            // 局域网报警相关
            case EUIMSG.DEV_SET_ATTR: {
                LUtils.i(TAG, "EUIMSG.DEV_SET_ATTR");
            }
            break;
            case EUIMSG.DEV_GET_LAN_ALARM: {
                // 收到局域网报警消息
                LUtils.i(TAG, "EUIMSG.DEV_GET_LAN_ALARM");
                // 设备的序列号
                String devSn = msgContent.str;
